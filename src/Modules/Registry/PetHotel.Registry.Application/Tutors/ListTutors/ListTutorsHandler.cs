...
public static class ListTutorsHandler
{
    private const int MaxLimit = 100;
    private const int DefaultLimit = 20;

    public static async Task<Result<CursorPage<TutorDto>>> Handle(
        ListTutors query,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await queries.ListAsync(query.Search, after, limit, cancellationToken);
    }
}
